      ...
      <section className="px-6 py-10 border-t border-ls-border">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6">
            <span className="text-ls-accent">How</span>{' '}
            ...
            {' '}<span className="text-ls-accent">Works</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="text-center p-6">
                <div className="w-20 h-20 mx-auto mb-6 bg-ls-accent/10 border-4 border-ls-accent rounded-xl flex items-center justify-center">
